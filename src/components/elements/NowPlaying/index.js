...
import bombsquad from "../../../assets/images/bombsquad.jpg"
import disavowed from "../../../assets/images/disavowed.png"
import hazelwood from "../../../assets/images/hazelwood.jpg"
import missioncontrol from "../../../assets/images/missioncontrol.jpg"
import wellingtonmanor from "../../../assets/images/wellingtonmanor.jpg"
        ...
        <section id="first" class="main special">
            ...
            <div className="game-section">
                <div className="left-div">
                    {/* {<Carousel showThumbs={false} width="450px" />} */}
                    <img className="poster" src={bombsquad} />
                </div>
                <div className="right-div">
                    <h2 className="center">Bomb Squad</h2>
                    <p>
            ...
            <div className="game-section">
                <div className="left-div">
                    <h2 className="center">Hazelwood Heist</h2>
                    <p>
                ...
                <div className="right-div">
                    <img className="poster" src={hazelwood} />
                </div>
            </div>
            <div className="game-section">
                <div className="left-div">
                    <img className="poster" src={missioncontrol} />
                </div>
                <div className="right-div">
                    <h2 className="center">Mission Control</h2>
                    <p>
            ...
            <div className="game-section">
                <div className="right-div">
                    <h2 className="center">Disavowed</h2>
                    <p>
                ...
                <div className="left-div">
                    <img className="poster" src={disavowed} />
                </div>
            </div>
            <div className="game-section">
                <div className="left-div">
                    <img className="poster" src={wellingtonmanor} />
                </div>
                <div className="right-div">
