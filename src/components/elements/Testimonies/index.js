      ...
      <div>
        <Slider {...settings}>
            <div>
                <div>
                    <div style={slideStyle}>
                        <a target="_blank" style={{ textDecoration: 'none' }} href="https://www.tripadvisor.ca/ShowUserReviews-g60403-d12839497-r755393369-Dells_Escape_Rooms-Wisconsin_Dells_Wisconsin.html">
                            <div>
                                <div>
                                    <span className="icon brands fa-tripadvisor alt"></span>Audrey V wrote a review May 2020
                                </div>
                                <h3 className="gold"><u className="gold">Amazing</u></h3>
            ...
            <div>
                <div>
                    <div style={slideStyle}>
                        <a target="_blank" style={{ textDecoration: 'none' }} href="https://www.tripadvisor.com/ShowUserReviews-g60403-d12839497-r733994729-Dells_Escape_Rooms-Wisconsin_Dells_Wisconsin.html">
                            <div>
                                <div>
                                    <span className="icon brands fa-tripadvisor alt"></span>Kate C wrote a review Dec 2019
                                </div>
                                <h3 className="gold"><u className="gold">Christmas gift for family... SO MUCH FUN!</u></h3>
            ...
            <div>
                <div>
                    <div style={slideStyle}>
                        <a target="_blank" style={{ textDecoration: 'none' }} href="https://www.tripadvisor.com/ShowUserReviews-g60403-d12839497-r690976868-Dells_Escape_Rooms-Wisconsin_Dells_Wisconsin.html">
                            <div>
                                <div>
                                    <span className="icon brands fa-tripadvisor alt"></span>Pcarl wrote a review Jul 2019
                                </div>
                                <h3 className="gold"><u className="gold">So much fun!</u></h3>
